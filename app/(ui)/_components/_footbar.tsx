...
import { contacts, siteMap, services } from "../../lib/data.js";

export default function Footbar() {
  const dt = new Date().getFullYear();

  return (
    <div className="j-bg-lightgrey dark:bg-gray-900 shadow">
      <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            ...
            <p className="mt-6 max-w-md text-center leading-relaxed text-gray-500 sm:max-w-xs sm:text-left dark:text-gray-400"></p>
            <p className="mt-6 max-w-md text-center leading-relaxed text-gray-500 sm:max-w-xs sm:text-left dark:text-gray-400"></p>
            <p className="mt-6 max-w-md text-center leading-relaxed text-gray-500 sm:max-w-xs sm:text-left dark:text-gray-400"></p>
              ...
              <ul className="mt-8 space-y-4 text-sm">
                ...
                <li className="flex items-start justify-center gap-1.5 ltr:sm:justify-start rtl:sm:justify-end">
                  ...
                  <address className="-mt-0.5 flex-1 not-italic text-gray-700 dark:text-gray-300">
                    Address : 4th Floor, Janki Smruti Building, L.T.Road, Near
                    Siddharth Hospital, Next to Gurudwara, Goregoan West, Mumbai
                    - 400062
                  </address>
                </li>
              </ul>
        ...
        <div className="mt-12 border-t border-gray-100 pt-6 dark:border-gray-800">
          <div className="text-center sm:flex sm:justify-between sm:text-left">
            ...
            <p className="mt-4 text-sm text-gray-500 sm:order-first sm:mt-0 dark:text-gray-400">
              &copy; {dt} Jaaguar Media Solution
            </p>
          </div>
        </div>
      </div>
